            ...
            try {
                ...
                if (scriptContext.type == "view" || scriptContext.type == "edit") {
                    ...
                    for (var i = 0; !utilidades.isEmpty(arrayRetenciones) && i < arrayRetenciones.length; i++) {
                        ...
                        if (arrayRetenciones[i].ret_tipo == 3 && !utilidades.isEmpty(arrayRetenciones[i].ret_tipo_contrib_iibb)) {
                            ...
                            if (!utilidades.isEmpty(total) && total > 0.00 && cantidadRetenciones > 0) {
                                ...
                                for (var i = 0; i < cantidadRetenciones; i++) {
                                    ...
                                    if (!utilidades.isEmpty(importeRetener) && !isNaN(importeRetener) && parseFloat(importeRetener, 10) > 0) {
                                        ...
                                        if (idTipoRetencion == 3 && !utilidades.isEmpty(idTipoContribuyente)) {
        ...
        function procesaVendorPayment(type, recType, recId, objRta, infoRetIIBB, script) {
            ...
            try {
                ...
                log.debug("Governance Monitoring monto_ret_suss", "Memoria = " + script.getRemainingUsage());
                            ...
                            if (parseFloat(monto_ret_iibb, 10) != 0 && !utilidades.isEmpty(parseFloat(monto_ret_iibb, 10))) {
                                var importeIIBB;
                        ...
                        for (var j = 0; !utilidades.isEmpty(numLinesRetenciones) && j < numLinesRetenciones; j++) {
                            ...
                            log.debug("L54 - Calcular Retenciones (SS)", "AFTERSUBMIT - PROCESAVENDORPAYMENT - ARRAYIDGAN: " + JSON.stringify(arrayIdGAN) + " - ARRAYIDIVA: " + JSON.stringify(arrayIdIVA) + " - ARRAYIDIIBB: " + JSON.stringify(arrayIdIIBB) + " - ARRAYIDSUSS: " + JSON.stringify(arrayIdSUSS));
                    ...
                    if (type == "edit") { // Alex Editar
                        ...
                        if (parseFloat(monto_ret_ganancias, 10) != 0 || parseFloat(monto_ret_suss, 10) != 0 || parseFloat(monto_ret_iva, 10) != 0 || parseFloat(monto_ret_iibb, 10) != 0) {
                            ...
                            try {
                                ...
                                if (objDatosImpositivos[0].applyAccountClearing) { // si se aplica clearing
                                    recordT.setValue('account', cuentaClearing);
                                }
        ...
        function guardarRetenciones(datosRetencion, paramRetenciones, entity, id_posting_period, tasa_cambio_pago, moneda, fecha, esRetIIBB) {
            ...
            try {
                ...
                if (esRetIIBB) {
                    ...
                    if (datosRetencion.retencion == 3 && !utilidades.isEmpty(datosRetencion.condicionID)) {
