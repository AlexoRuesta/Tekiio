 ...
 */
 ...
 define(['N/format', 'L54/utilidades', 'N/search', 'N/runtime'],
    function (format, utilidades, search, runtime) {
      ...
      function generarPercepciones(parameters) {
        ...
        try {
                  ...
                  const jurisdiccionNoPosee = currentScript.getParameter("custscript_l54_calcular_percep_no_pos");
                  const jurisdiccionCFE = currentScript.getParameter("custscript_l54_calcular_percep_juris_cfe");
                  const jurisdiccionBUE = currentScript.getParameter("custscript_l54_calcular_percep_juris_bue");
                  const jurisdiccionTUCUMAN = currentScript.getParameter("custscript_l54_calcular_percep_juris_tuc");
                  ...
                  var paramAplicaEnLaProvincia = currentScript.getParameter('custscript_l54_calcular_percep_cal_en_pr');
                  var paramAplicaFueraProvincia = currentScript.getParameter('custscript_l54_calcular_percep_cal_fue_p');
                  var paramNoAplicaProvincia = currentScript.getParameter('custscript_l54_calcular_percep_cal_no_ap');
        ...
        try {
            ...
            // Segmento encargado de validar si la jurisdiccion de empresa aplica en la provincia, fuera de la provincia o no aplica en la provincia.
              ...
              objPercepcion[cantidadElementos].critJurisdEmpresa = infoTerritorialidadLinea.critJurisdEmpresa;
                 ...
                 log.debug( 'L54 - Calculo Percepciones', 'RETURN - agregarJurisdiccionesIIBB: ' + JSON.stringify(objPercepcion));
      ...
      function getClienteInscriptoRegimenIIBB(id_cliente, idEstadoExento, jurisdiccionesIIBB, idTipoContribIIBBDefault, idTipoContribIIBBDefaultText, coeficienteBaseImponible, jurisdiccionesObligatorias, trandate, jurisdiccionesEntregaFacturas) {
       ...
       log.debug( 'getClienteInscriptoRegimenIIBB', 'RETURN getClienteInscriptoRegimenIIBB: ' + JSON.stringify(estadoInscripcionCliente))
      ...
      function obtenerCodigosPercepcionIIBB(id_cliente, subsidiaria, objEstadosIIBB, idConfGeneral, tipoCambio, costoEnvio, tipoContribuyente, paramNoAplicaProvincia, periodo) {
       ...
       log.debug( 'obtenerCodigosPercepcionIIBB', 'RETURN - obtenerCodigosPercepcionIIBB: ' + JSON.stringify(codigosPercepcionIIBB));
    ...
    function obtenerArregloCodigosPercepcionPadronIIBB(id_cliente, subsidiaria) {
       ...
       log.debug( 'obtenerArregloCodigosPercepcionPadronIIBB', 'RETURN - obtenerArregloCodigosPercepcionPadronIIBB: ' + JSON.stringify(arregloCodigosPercepcionIIBB));
