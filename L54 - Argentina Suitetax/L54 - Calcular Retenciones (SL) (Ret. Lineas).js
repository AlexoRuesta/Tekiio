        ...
        function onRequest(context) {
            ...
            try {
                ...
                if (context.request.method == 'GET' || context.request.method == 'POST') {
                    ...
                    var retencionHonorarios = script.getParameter('custscript_l54_cal_ret_sl_ret_li_gan_hon');
                    var jurisdiccionCordoba = script.getParameter('custscript_l54_cal_ret_sl_ret_li_jur_cor');
                    var paramAplicaEnLaProvincia = script.getParameter('custscript_l54_cal_ret_sl_apl_cal_en_pro');
                    var paramAplicaFueraProvincia = script.getParameter('custscript_l54_cal_ret_sl_apl_cal_fu_pro');
                    var paramNoAplicaProvincia = script.getParameter('custscript_l54_cal_ret_sl_no_apl_cal_ter');
                    var paramJurisdTucuman = script.getParameter('custscript_l54_cal_ret_sl_jurisd_tucuman');
