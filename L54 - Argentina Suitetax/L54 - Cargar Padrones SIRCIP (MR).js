...
function (runtime, libSearch, record, email, format) {
    ...
    var proceso = "L54 - Carga Padron SIRCIP (MR)";
    ...
    function map(context) {
        try {
            ...
            // 1. Buscar los clientes con el mismo cuit
    ...
    function getParameters() {
        try {
            ...
            parameters.input = JSON.parse(currScript.getParameter({ name: 'custscript_l54_pad_sircip_mr_input'}));
